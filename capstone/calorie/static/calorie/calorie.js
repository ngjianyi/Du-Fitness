...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (document.querySelector('#calories-form')) {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (document.querySelector('#recommended-calories-form')) {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (document.querySelector('#custom-calories-form')) {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (document.querySelector('#calculator-calories')) {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (document.querySelector('#custom-calories')) {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (document.querySelector('#calculated-calories')) {
